...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#projectspecconfigurationref">configurationRef</a></b></td>
        <td>object</td>
        <td>
        ...
        <td>string</td>
        <td>
          Only updatable field, not allowed in create<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#projectspeccapabilities">capabilities</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#projectspeccapabilitiesprocesstemplate">processTemplate</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#projectspeccapabilitiesversioncontrol">versioncontrol</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
### Project.spec.capabilities.processTemplate
<sup><sup>[↩ Parent](#projectspeccapabilities)</sup></sup>
...
### Project.spec.capabilities.versioncontrol
<sup><sup>[↩ Parent](#projectspeccapabilities)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          Project identifier. (format: uuid)<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>name</b></td>
        ...
        <td>integer</td>
        <td>
          Project revision. (format: int64)<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
        ...
        <td>
          Project state.<br/>
          <br/>
            <i>Enum</i>: deleting, new, wellFormed, createPending, all, unchanged, deleted<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>url</b></td>
        <td>string</td>
        <td>
          Url to the full version of the object.<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
