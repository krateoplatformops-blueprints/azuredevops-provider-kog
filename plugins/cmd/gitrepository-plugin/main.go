...
import (
	...
	gitrepository "github.com/krateoplatformops/azuredevops-provider-kog/gitrepository-plugin/handlers"
...
func main() {
	...
	// GitRepository
	srv.Mux().Handle("POST /api/{organization}/{projectId}/git/repositories", gitrepository.PostGitRepository(opts))
